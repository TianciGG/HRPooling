...
/**
 * Servlet implementation class SaveDutyInfo
 */
@WebServlet("/SaveDutyInfo")
public class SaveDutyInfo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Boolean flag = dutyService.addDuty(dutyInfo);
		// 4.返回提示信息
