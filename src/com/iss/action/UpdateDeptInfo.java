...
/**
 * Servlet implementation class UpdateDeptInfo
 */
@WebServlet("/UpdateDeptInfo")
public class UpdateDeptInfo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Integer deptId =Integer.parseInt(request.getParameter("deptId"));
				...
				String superDeptName =(String)(request.getParameter("superId"));
				...
				Boolean flag = deptService.updateDept(deptInfo);
				//4.返回提示信息
