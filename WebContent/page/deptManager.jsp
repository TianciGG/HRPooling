			...
			<div class="am-modal-bd">
				<form class="form-horizontal" method="post">
					...
					<div class="form-group">
						<label for="deptNO" class="col-sm-3 control-label">部门编号：</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="dpPhone" class="col-sm-3 control-label">部门电话：</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="dpPhone"
								name="dpPhone">
						</div>
					</div>

					<div class="form-group">
						<label for="superId" class="col-sm-3 control-label">上级部门：</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="deptProfile" class="col-sm-3 control-label">部门备注：</label>
						<div class="col-sm-8">
							<textarea class="form-control" rows="3" id="dpProfile"
								name="dpProfile"></textarea>
						</div>
					</div>
