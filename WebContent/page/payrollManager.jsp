...
<!--外联js表-->
<script type="text/javascript" src="../js/payrollManager.js"></script>
</head>
...
<!-- 侧边导航栏 -->
	<div class="left-sidebar">
		...
		<ul class="sidebar-nav">
			...
			<li class="sidebar-nav-link"><a href="javascript:;"
					...
					<li class="sidebar-nav-link"><a href="payrollManager.jsp" class="sub-active">
							<span class="am-icon-angle-right sidebar-nav-link-logo"></span>
							实发薪资管理
					</a></li>
	...
	<div class="tpl-content-wrapper">
		...
		<table id="tbPayroll" toolbar="#toolbar"></table>
		</div>
		</div>
		</div>
		</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title" id="SaveModalLabel">添加实发薪资信息</h4>
					<h4 class="modal-title" id="UpdateModalLabel">修改实发薪资信息</h4>
				</div>
				<!--模态框主题内容-->
				<div class="modal-body">
					...
					<form class="form-horizontal">
						...
						<div class="form-group">
							<div class="col-sm-10">
								<input type="hidden" class="form-control" id="payrollId">
							</div>
						</div>
						...
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-2 control-label">扣款</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-2 control-label">实发薪资</label>
							<div class="col-sm-10">
