...
<body>
	<div class='login'>
		...
		<div class='login_fields'>
			...
			<div class='login_fields__submit'>
				<a id="btnSubmit"><input type='button' value='登 录'
	...
	<script type="text/javascript">
		...
		layui.use('layer', function() {
			...
			//		var index = layer.alert(msgalert, { icon: 6, time: 0, offset: 't', closeBtn: 0, title: '友情提示', btn: [], anim: 2, shade: 0 });  
			//			layer.style(index, {
			//				color: '#777'
			//			}); 
			//非空验证
