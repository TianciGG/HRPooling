...
<meta name="description" content="这是一个招聘信息爬取页面">
<meta name="keywords" content="spiderRecruit">
...
<script type="text/javascript" src="js/logic/spiderRecruit.js"></script>
...
<body data-type="widgets" style="overflow-y: auto;">
	...
	<div class="am-g tpl-g">
		...
		<div class="left-sidebar">
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-nav-link"><a href="page/index.jsp"
				...
				<li class="sidebar-nav-link"><a href="javascript:;"
					...
					<ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
						<li class="sidebar-nav-link"><a href="page/recruitManager.jsp"
							> <span
						...
						<li class="sidebar-nav-link"><a href="goToSpiderRecruitPage.do" class="sub-active">
								<span class="am-icon-angle-right sidebar-nav-link-logo"></span>
								招聘信息搜索引擎
						</a></li>
				...
				<li class="sidebar-nav-link"><a href="javascript:;"
					...
					<ul class="sidebar-nav sidebar-nav-sub">
						<li class="sidebar-nav-link"><a href="page/NoticeType.jsp"> <span
								class="am-icon-angle-right sidebar-nav-link-logo"></span> 公告类型
						</a></li>

						<li class="sidebar-nav-link"><a href="page/Notice.jsp">
								<span class="am-icon-angle-right sidebar-nav-link-logo"></span>
								公告管理
						</a></li>
					</ul></li>
					...
					<ul class="sidebar-nav sidebar-nav-sub">
						<li class="sidebar-nav-link"><a href="page/dicValue.jsp"> <span
								class="am-icon-angle-right sidebar-nav-link-logo"></span> 数据字典
						</a></li>
						<li class="sidebar-nav-link"><a href="page/dicTypeManager2.jsp">
								<span class="am-icon-angle-right sidebar-nav-link-logo"></span>
								数据类型
						</a></li>
			...
			<div class="row-content am-cf">
				<div class="panel panel-danger">
					<div class="panel-heading">
						<strong class="am-text-primary am-text-lg">招聘信息搜索引擎</strong> / <small>爬取招聘信息</small>
					</div>
					<div class="panel-body" >
						<!-- 选项卡 -->
						<ul id="myTab" class="nav nav-tabs">
							<li id="ZhiLian" class="active"><a href="#tblResultDiv1"
								data-toggle="tab">智联招聘网数据</a></li>
							<li id="QianCheng"><a href="#tblResultDiv2" data-toggle="tab">前程无忧网数据</a></li>
						</ul>
								...
								<table id="tblResult1"
									...
									<thead>
										<tr>
											...
											<th class=" text-center" data-field="xuhao" data-formatter="xuhao">序号</th>
											<th class=" text-center" data-field="position">职位名称</th>
											<th class=" text-center" data-field="company">公司名称</th>
											<th class=" text-center" data-field="workplace">工作地点</th>
											<th class=" text-center" data-field="salary">职位月薪</th>
											<th class=" text-center" data-field="date">发布日期</th>
											<!-- <th class=" text-center"
												data-field="recruitOtherInfo.companynature">公司性质</th>
											<th class=" text-center"
												data-field="recruitOtherInfo.companyscale">公司规模</th>
											<th class=" text-center"
												data-field="recruitOtherInfo.experience">经验要求</th>
											<th class=" text-center"
												data-field="recruitOtherInfo.education">学历要求</th> -->
											<th class=" text-center"
												data-formatter="xiangqing">详细信息</th>
										</tr>
									</thead>
	...
	<div class="am-modal am-modal-prompt" tabindex="-1"
		...
		<div class="am-modal-dialog">
			<div class="am-modal-hd">
				<font size="4px" id="editModalHead"></font>
	...
	<div class="am-modal am-modal-confirm" tabindex="-1"
		...
		<div class="am-modal-dialog">
			...
			<div class="am-modal-footer">
				<span class="am-modal-btn" data-am-modal-cancel>取消</span> <span
					class="am-modal-btn" data-am-modal-confirm onclick="delByIndex()">确定</span>
			</div>
		</div>
	</div>
